...
void Renderer2D::Init() {
  ...
  delete[] quadIndices; // Can cause issues later with referece depending on
                        // thread
  ...
  s_Data.Shaders.Load("CircleShader", "Resources/Shader/2D/CircleShader.vert",
                      "Resources/Shader/2D/CircleShader.frag");
  s_Data.Shaders.Load("LineShader", "Resources/Shader/2D/LineShader.vert",
                      "Resources/Shader/2D/LineShader.frag");
...
void Renderer2D::Shutdown() { CE_PROFILE_FUNCTION(); }
