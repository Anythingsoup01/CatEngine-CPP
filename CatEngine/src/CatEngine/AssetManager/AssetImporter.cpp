...
namespace CatEngine
{
    using AssetImportFunction = std::function<Ref<Asset>(AssetHandle, Ref<Asset::MetaData>&)>;
    using ConstAssetImportFunction = std::function<Ref<Asset>(AssetHandle, const Ref<Asset::MetaData>&)>;
    ...
    Ref<Asset> AssetImporter::ImportAsset(const AssetHandle &handle, Ref<Asset::MetaData>& metaData)
    {
